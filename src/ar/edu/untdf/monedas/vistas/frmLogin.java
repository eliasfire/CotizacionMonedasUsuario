	...
	public frmLogin()
	{
		...
		btnAceptar.addActionListener( 
			new ActionListener()
			{
				...
				{
					UsuarioJpaController user = new UsuarioJpaController(Persistence.createEntityManagerFactory("CotizacionMonedasUsuario"));
					...
					try {
						...
						if ((x_user != "") && (x_pass != ""))
						{
							...
							JOptionPane.showMessageDialog( frmLogin.this,
									"Bienvenido al sistema usuario: " + x_user ,
