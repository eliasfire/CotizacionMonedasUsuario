...
public class UsuarioJpaController implements Serializable {
    ...
    public void destroy(int codigo) throws NonexistentEntityException {
        ...
        try {
            ...
            Usuario usuario;
            try {
                usuario = em.getReference(Usuario.class, codigo);
                usuario.getIdusuario();
            } catch (EntityNotFoundException enfe) {
                throw new NonexistentEntityException("The Usuario with id " + codigo + " no longer exists.", enfe);
            }
            em.remove(usuario);
            em.getTransaction().commit();
        } finally {
    ...
    public Usuario findUsuarioPorLogin(String usuarioLogin) throws Exception {
        ...
        Usuario user = null;
        try {
			System.out.println("consultado " + usuarioLogin);
